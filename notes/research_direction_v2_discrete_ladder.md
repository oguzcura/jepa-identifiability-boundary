...
| "Your Probabilistic JEPA Is Secretly a Hidden Markov Model" (arXiv:2608.13621) | State-space **structural interpretation** of probabilistic JEPA (PIB-VJEPA) — shows HMM-like correspondence. **Watch this one**: if extended to empirical discrete-state recovery it partially claims our L2 lane (fast-pass mitigation → §6). |
...
| "No Gaussian Required" (arXiv:2608.17542) | Replaces SIGReg Gaussian-prescription with **contrastive inverse dynamics** — strengthens our SIGReg-insurance sub-hypothesis (H2), does not test discrete recovery. |
